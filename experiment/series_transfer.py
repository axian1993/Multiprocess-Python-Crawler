...
if __name__ == "__main__":
    #对离散的时间戳做count
    # with open("data/weibo/users.json", 'r') as input, open("data/weibo/month_series", "w") as output:
    #     for line in input:
    #         line = eval(line)
    #
    ...
    #         #cnt_list = stamp.fixIntervalCnt('year')
    #
    #         out = {}
    ...
    #标准化cnt序列
    rootdir = "data/weibo/cnt"
    outputdir = "data/weibo/norm_cnt"
